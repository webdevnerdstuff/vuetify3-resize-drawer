...
- Check out the [existing issues](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/issues).

### Don't see your issue? Open one

If you spot something new, open an issue using a [template](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/issues/new/choose). We'll use the issue to have a conversation about the problem you want to fix.
...
Once your PR is merged, you will be proudly listed as a contributor in the [contributor chart](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/graphs/contributors).
...
If you'd like help troubleshooting a Vue Unicorn Log PR you're working on, have a great new idea, or want to share something amazing you've learned, join us in [discussions](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/discussions).
...
- The [`help wanted` label](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/issues?q=is%3Aopen+is%3Aissue+label%3Aenhancement) is for problems or updates that anyone in the community can start working on.
- The [`documentation` label](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/issues?q=is%3Aopen+is%3Aissue+label%3Adocumentation) is for problems or updates relating to the README.MD documentation.
- The [`bug` label](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/issues?q=is%3Aopen+is%3Aissue+label%3Abug) is for problems with the code and bugs.
- The [`enhancement` label](https://github.com/webdevnerdstuff/vuetify3-resize-drawer/issues?q=is%3Aopen+is%3Aissue+label%3Aenhancement) is for 
